  ...
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="updateBookingModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" wire:click.prevent="update()">Update Booking</button>
        </div>
      </div>
    </div>
  </div>