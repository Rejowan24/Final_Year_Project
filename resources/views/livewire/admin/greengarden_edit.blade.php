  ...
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="editfoodcourt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit Food(Green Garden)</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" wire:click.prevent="Updatefood">Update Food</button>
        </div>
      </div>
    </div>
  </div>